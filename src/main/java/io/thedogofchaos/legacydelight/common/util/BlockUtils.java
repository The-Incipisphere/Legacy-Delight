...
public class BlockUtils {
    /// Because bounds aren't defined in 'Number of subpixels of a block' in 1.7.10 (compared to later versions), they're defined in 'Fractions of a block' (i.e. 1/16 = 0.0625)
     ...
     */
    public static void setSaneBounds(Block block, float minX, float minY, float minZ, float maxX, float maxY, float maxZ)
    {
        ...
        block.setBlockBounds(minX * boundsMult, minY * boundsMult, minZ * boundsMult, maxX * boundsMult, maxY * boundsMult, maxZ * boundsMult);
    }
}
